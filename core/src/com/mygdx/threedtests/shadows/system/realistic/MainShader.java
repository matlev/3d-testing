...
import com.mygdx.threedtests.shadows.system.BaseShadowSystem.LightProperties;
...
public class MainShader extends DefaultShader {
	...
	public static String getDefaultVertexShader () {
		if (defaultVertexShader == null) defaultVertexShader = Gdx.files
			.internal("shaders/shadows/system/realistic/main.vertex.glsl").readString();
	...
	public static String getDefaultFragmentShader () {
		if (defaultFragmentShader == null) defaultFragmentShader = Gdx.files
			.internal("shaders/shadows/system/realistic/main.fragment.glsl").readString();
